...
/*
 * `sound` on LevelSoundEventPacket used to be an int constant from
 * LevelSoundEvent, now it's a string name (e.g. "item.use.on"). This table
 * maps between them by matching constant names across both vendor versions
 * (55.0.0 and 58.0.0) rather than guessing.
 *
 * 1 constant (STOP_RECORD) was dropped in 1.26.30 and can't be sent anyway
 * since PM no longer references it. 15 new sounds in 1.26.30 have no old
 * equivalent and fall back to LevelSoundEvent::DEFAULT (186).
 */
...
final class LegacySoundMap{
	...
	/** Fallback used when a new sound has no equivalent in 1.26.0-1.26.20 */
