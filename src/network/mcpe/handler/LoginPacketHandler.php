...
class LoginPacketHandler extends PacketHandler{
	...
	protected function parseClientData(string $clientDataJwt) : ClientData{
		...
		//MultiVersion: legacy-protocol clients (1.26.0/1.26.10/1.26.20) don't send
		//a few new claims marked @required on this 1.26.30 version of the ClientData
		//class. Without this, JsonMapper would throw and the legacy client would
		//fail to log in entirely. Old fields that have since been removed (e.g. IsEditorMode)
		//don't need to be handled since they only trigger a warning, not an error.
